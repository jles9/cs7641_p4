...
def plot_basic_exp(data, problemName):
    ...
    plt.savefig('./graphs/VI/{}_meanV.png'.format(problemName))
    ...
    plt.savefig('./graphs/VI/{}_maxV.png'.format(problemName))
    ...
    plt.savefig('./graphs/VI/{}_error.png'.format(problemName))
...
def plot_gamma_exp(data, problemName):
    ...
    plt.savefig('./graphs/VI/{}_maxV_gamma.png'.format(problemName))
...
def runForestExp():
    ...
    cuts = np.sum(vi_agent.policy)
    wait = len(vi_agent.policy) - cuts

    print("Forest Basic Runtime VI: {} \n".format(runtime))
    print(("Forest Basic Policy Cuts VI: {} \n".format(cuts)))
    print(("Forest Basic Policy Waits VI: {} \n".format(wait)))
    plot_basic_exp(result, problemName="forest")


def runFrozenLakeExp():
    # This will be the "small" problem 
    ...
    print("Frozen Lake Basic Runtime VI: {} \n".format(runtime))
